...
public class FutureActivity extends NewsActivity {
    private String TAG = FutureActivity.class.getSimpleName();
    private String URL_ANALYSIS_INFO = "http://www.wuzhenweb.com:8089/json?operation=getfxnews&item=future";
    private SwipeRefreshLayout swipeRefreshLayout;
    private SwipeNewsListAdapter adapter;
    private ListView listView;
    private List<NewsInfo> newsList;
    private int offSet = 0;
private String fileName="FutureData";
