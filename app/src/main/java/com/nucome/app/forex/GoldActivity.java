...
public class GoldActivity extends NewsActivity {
    private String TAG = GoldActivity.class.getSimpleName();
    private String URL_ANALYSIS_INFO = "http://www.wuzhenweb.com:8089/json?operation=getfxnews&item=gold";
