 ...
 */
public class LoginActivity extends RegisterActivity implements LoaderCallbacks<Cursor> {
    private String TAG = LoginActivity.this.getClass().getSimpleName();
    private String URL_LOGIN_INFO = "http://www.wuzhenweb.com:8089/json?operation=loginuser";
                        ...
                        public void onResponse(String response) {
                            ...
                            if (response.length() > 0) {
                                try {
                                    ...
                                    if ("110".equals(recommendObj.getString("errorCode"))) {
                                        ...
                                        editor.putString(getString(R.string.PREF_USER_TOKEN), recommendObj.getJSONObject("content").getString("token"));
                                        editor.commit();
                                        Toast.makeText(getApplicationContext(), mEmail + " login successful.", Toast.LENGTH_LONG).show();
