...
public class TradeForexActivity extends AppCompatActivity {
    private WebView webView;
    private final String TAG = TradeForexActivity.this.getClass().getSimpleName();
    private ProgressDialog progressBar;
    String url="http://www.wuzhenweb.com/forex/trade_forex.html";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
       // requestWindowFeature(Window.FEATURE_NO_TITLE);
        setContentView(R.layout.activity_trade_forex);
        this.webView = (WebView) findViewById(R.id.tradeForexWebView);
       ...
       // progressBar = ProgressDialog.show(LearningSeminarActivity.this, "外汇学堂", "Loading");
        webView.setWebViewClient(new WebViewClient() {
            ...
            public void onReceivedError(WebView view, WebResourceRequest request, WebResourceError error) {
                ...
                Toast.makeText(TradeForexActivity.this, "Error: " + error.toString(), Toast.LENGTH_SHORT).show();
